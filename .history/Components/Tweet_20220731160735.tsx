  ...
  return (
    <div className="flex flex-col space-x-3 border-y p-5 border-gray-100">
      ...
      <div className="flex mt-5 justify-between">
        <div
          onClick={() => setCommentBoxIsVisible(!commentBoxIsVisible)}
      ...
      {commentBoxIsVisible && (
        <form className="mt-3 flez space-x-3">
          <input
            className=" flex-1 rounded-lg bg-gray-100 p-2 outline-none bg-transparent text-white placeholder:text-white"
            type="text"
