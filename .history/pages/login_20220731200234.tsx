  ...
  return (
    <>
      <div className=" flex flex-col justify-center items-center min-h-screen py-2  px-14 text-center">
        ...
        <div className="flex flex-row space-x-4 mt-40">
          {Object.values(providers).map((provider) => (
            <div className="flex " key={provider.name}>
              <button
                className=" flex  items-center space-x-2 rounded-lg bg-transparent border-solid border-2 text-black   border-[rgb(207 217 222);] p-5 px-2"
