  ...
  return (
    <>
      <div className=" bg-black flex flex-col justify-center items-center min-h-screen py-2  px-14 text-center">
        ...
        <div className="flex flex-col items-center space-x-1 mt-40 md:flex-row md:space-x-3">
          {Object.values(providers).map((provider) => (
            <div className="flex " key={provider.name}>
              <button
                className=" p-4 m-4  flex  items-center  rounded-lg  bg-twitter  text-white sm:p-4  "
